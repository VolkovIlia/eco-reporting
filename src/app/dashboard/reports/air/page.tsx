...
export default async function AirReportPage({ searchParams }: Props) {
  ...
  if (!report || report.type !== "2tp_air") notFound();
  ...
  return (
    <div className="max-w-4xl space-y-4">
      <div>
        <h1 className="text-2xl font-bold text-gray-900">2-ТП Воздух</h1>
        <p className="text-sm text-gray-500 mt-1">
          Форма федерального статистического наблюдения № 2-ТП (воздух)
        </p>
      </div>
      <Card>
        <AirForm
